...
import { CustomNodeType, nodeHeight, nodeWidth, useLayoutedElements } from '../Mainflow';
...
function AgentNode({ id, data, isConnectable }: NodeProps) {
  const { addNodes, addEdges, getEdges, getNodes, setNodes, setEdges, deleteElements, getNode, getEdge } = useReactFlow();
